...
(function (global, factory) {
    ...
    var SignaturePad = (function () {
        ...
        SignaturePad.prototype.convertISODataToCsv = function (data) {
            var result;
            var ctr;
            var columnDelimiter = ',';
            var lineDelimiter = '\n';
        ...
        SignaturePad.prototype.saveCsv = function () {
            var csvData = this.convertISODataToCsv(this.toISOData());
            var csv = '';
            if (csvData == null)
                return;
        ...
        SignaturePad.prototype.toISOData = function () {
            ...
            var firstPointTime = previousPoint.time;
            var captureDateAndTime = new Date(previousPoint.time).toISOString();
            var isoData = {
                captureDateAndTime: captureDateAndTime,
                points: []
            };
