...
export default class SignaturePad {
  ...
  public convertISODataToCsv(data: any): string {
    let result: string;
    let ctr: number;
  ...
  public saveCsv(): void {
    const csvData = this.convertISODataToCsv(this.toISOData());
    let csv = '';
  ...
  public toISOData(): object {
    ...
    const firstPointTime = previousPoint.time;
    const captureDateAndTime = new Date(previousPoint.time).toISOString();
    const isoData = {
      captureDateAndTime,
      points: [] as any,
    };
